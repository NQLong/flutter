    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Quote` (`id` INTEGER NOT NULL, `text` TEXT NOT NULL, `author` TEXT NOT NULL, PRIMARY KEY (`id`))');
...
class _$QuoteDao extends QuoteDao {
  ...
  @override
  Future<void> insertPerson(Quote person) async {
    await _quoteInsertionAdapter.insert(person, OnConflictStrategy.abort);
  }
}
